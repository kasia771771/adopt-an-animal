...
export default function FindCareForm() {
  ...
  return (
    <div className="form-wrapper">
      <form
        action=""
        className={success ? "form-none" : "form"}
      ...
      >
        ...
        <div className="textarea-container">
          ...
          <label className="text-label">
            Tu wpisz choroby zwierzaka i jego historię
          </label>
        </div>
        ...
        <button className="submit-button">Znajdź opieke</button>
      </form>
      <div className={success ? "success-container" : "success-none"}>
        <i class="fas fa-paw paw-success"></i>
        <h3 className="success-title">Udało się!</h3>
        <p className="success-message">
          Twój zwierzak został dodany do zwierzaków szukających opieki
        </p>
      </div>
    </div>
  );
